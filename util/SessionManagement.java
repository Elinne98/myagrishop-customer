...
import com.myagrishop.customer.activity.MainActivity;

import java.util.HashMap;
import java.util.Map;

import static com.myagrishop.customer.config.BaseURL.APP_OTP_STATUS;
import static com.myagrishop.customer.config.BaseURL.CART_ID_FINAL;
import static com.myagrishop.customer.config.BaseURL.COUNTRY_CODE;
import static com.myagrishop.customer.config.BaseURL.IS_LOGIN;
import static com.myagrishop.customer.config.BaseURL.KEY_EMAIL;
import static com.myagrishop.customer.config.BaseURL.KEY_HOUSE;
import static com.myagrishop.customer.config.BaseURL.KEY_ID;
import static com.myagrishop.customer.config.BaseURL.KEY_IMAGE;
import static com.myagrishop.customer.config.BaseURL.KEY_MOBILE;
import static com.myagrishop.customer.config.BaseURL.KEY_NAME;
import static com.myagrishop.customer.config.BaseURL.KEY_PASSWORD;
import static com.myagrishop.customer.config.BaseURL.KEY_PAYMENT_METHOD;
import static com.myagrishop.customer.config.BaseURL.KEY_PINCODE;
import static com.myagrishop.customer.config.BaseURL.KEY_REWARDS_POINTS;
import static com.myagrishop.customer.config.BaseURL.KEY_SOCITY_ID;
import static com.myagrishop.customer.config.BaseURL.KEY_SOCITY_NAME;
import static com.myagrishop.customer.config.BaseURL.KEY_WALLET_AMMOUNT;
import static com.myagrishop.customer.config.BaseURL.MAP_SELECTION;
import static com.myagrishop.customer.config.BaseURL.PAYMENT_PAYPAL;
import static com.myagrishop.customer.config.BaseURL.PAYMENT_PAYSTACK;
import static com.myagrishop.customer.config.BaseURL.PAYMENT_RAZORPZY;
import static com.myagrishop.customer.config.BaseURL.TOTAL_AMOUNT;
import static com.myagrishop.customer.config.BaseURL.USER_CITY;
import static com.myagrishop.customer.config.BaseURL.USER_CURRENCY;
import static com.myagrishop.customer.config.BaseURL.USER_CURRENCY_CNTRY;
import static com.myagrishop.customer.config.BaseURL.USER_EMAIL_SERVICE;
import static com.myagrishop.customer.config.BaseURL.USER_INAPP_SERVICE;
import static com.myagrishop.customer.config.BaseURL.USER_LANG;
import static com.myagrishop.customer.config.BaseURL.USER_LAT;
import static com.myagrishop.customer.config.BaseURL.USER_OTP;
import static com.myagrishop.customer.config.BaseURL.USER_SKIP;
import static com.myagrishop.customer.config.BaseURL.USER_SMS_SERVICE;
import static com.myagrishop.customer.config.BaseURL.USER_STATUS;
import static com.myagrishop.customer.config.BaseURL.USER_STOREID;
